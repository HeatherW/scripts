...
path = '/home/heather/Desktop/books/scripts/tests/sample-files-for-testing'
file_list = os.listdir(path)
file_list.sort()

from number_html5 import GeneralNumberClass

number_class = GeneralNumberClass(file_list)
